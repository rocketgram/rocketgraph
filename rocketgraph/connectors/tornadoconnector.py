...
from .. import types
from ..errors import RocketgraphNetworkError, RocketgraphParseError
...
logger = logging.getLogger('rocketgraph.connectors.tornadoconnector')

HEADERS = {'Content-Type': 'application/json', 'User-Agent': USER_AGENT}


# TODO: adopt to rocketgraph
class TornadoConnector(Connector):
    ...
    async def send(self, token: str, request: Request) -> Response:
        try:
            ...
            raise RocketgraphParseError(e)
        except asyncio.CancelledError:
            raise
        except Exception as e:
            raise RocketgraphNetworkError(e)
